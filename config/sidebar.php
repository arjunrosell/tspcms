...
return [
    ...
    [
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 shrink-0" viewBox="0 0 24 24">
    ...
    [
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-6 h-6 shrink-0" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    [
        'icon' => '<svg class="w-6 h-6 shrink-0" viewBox="0 0 24 24">
    ...
    [
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 shrink-0">
