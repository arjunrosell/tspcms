<div>
    <div x-data="initData">
        <div class="mb-11">
            <div class="mb-4 ">
                <h2 class="text-2xl font-medium tracking-wide text-gray-800 dark:text-gray-100 ">Edit | Baptism</h2>
            </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('analytics-events-funeral-mass.add-baptism') }}"
        ...
        <div class="px-4 pt-8 pb-4 bg-white border border-gray-400 rounded-md ">
            ...
            <div class="grid grid-cols-3 gap-4 mb-8 ">
                ...
                <div class="inline-flex flex-col ">
                    <label for="" class="text-sm font-semibold tracking-wide text-gray-600 ">Lugar ng
                        Kapanganakan</label>
            ...
            <div class="grid grid-cols-2 gap-4 mb-8 ">
                <div class="inline-flex flex-col ">
                    <label for="" class="text-sm font-semibold tracking-wide text-gray-600 ">Edad ng Batang
                        Bibinyagan</label>
                    <input type="date" class=" form-input" wire:model='edad_ng_bibinyagan'>
                </div>
                <div class="inline-flex flex-col ">
                    <label for="" class="text-sm font-semibold tracking-wide text-gray-600 ">Kasarian</label>
            ...
            <fieldset class="mb-8  form-input">
                ...
                <div class="grid grid-cols-2 mb-8 ">
                    ...
                    <div class="flex flex-col gap-2 pl-2 ">
                        <div class="inline-flex flex-col ">
                            <label for="" class="text-sm font-semibold tracking-wide text-gray-600 ">Pangalan
                                ng Ina</label>
            ...
            <div class="grid grid-cols-2 gap-4 mb-8 ">
                <div class="inline-flex flex-col ">
                    <label for="" class="text-sm font-semibold tracking-wide text-gray-600 ">Saan Ikinasal ang
                        magulang ng bibinyagan</label>
                    <select name="" id="" class=" form-input"
                        wire:model='lugar_kinasal_ang_magulang'>
                        <option value="" selected>--Select--</option>
                ...
                <div class="inline-flex flex-col ">
                    <label for="" class="text-sm font-semibold tracking-wide text-gray-600 ">Kasalukuyang
                        Tirahan</label>
            ...
            <fieldset class="mb-8  form-input">
                ...
                <div class="grid grid-cols-2 mb-8 ">
                    <div class="flex flex-col gap-2 pr-2 ">
                        <div class="inline-flex flex-col ">
                            <label for=""
                                class="text-sm font-semibold tracking-wide text-gray-600 ">Pangunahing Ninong</label>
                    ...
                    <div class="flex flex-col gap-2 pl-2 ">
                        <div class="inline-flex flex-col ">
                            <label for=""
                                class="text-sm font-semibold tracking-wide text-gray-600 ">Pangunahing Ninang</label>
                ...
                <div class="grid grid-cols-2 mb-8 ">
                    <div class="flex flex-col gap-2 pr-2 ">
                        <div class="inline-flex flex-col ">
                            <div class="flex items-center justify-between mb-2">
                                <label for=""
                                    class="text-sm font-semibold tracking-wide text-gray-600 ">Ninong</label>
                                <button wire:click='addNinong'>
                                    <svg class="w-5 h-5 text-indigo-800 " xmlns="http://www.w3.org/2000/svg"
                            ...
                            @foreach ($ninongs as $index => $ninong)
                                <div class="relative mb-2 ">
                                    <input type="text" class="w-full  form-input"
                                        wire:model='ninongs.{{ $index }}'>
                                    <button wire:click='removeNinong({{ $index }})'
                                        class="absolute right-0 h-full px-3 transform bg-red-300 top-2/4 rounded-tr-md rounded-br-md -translate-y-2/4">
                    ...
                    <div class="flex flex-col gap-2 pl-2 ">
                        <div class="inline-flex flex-col ">
                            <div class="flex items-center justify-between mb-2">
                                <label for=""
                                    class="text-sm font-semibold tracking-wide text-gray-600 ">Ninang</label>
                            ...
                            @foreach ($ninangs as $index => $ninang)
                                <div class="relative mb-2 ">
                                    <input type="text" class="w-full  form-input"
                                        wire:model='ninangs.{{ $index }}'>
                                    <button wire:click='removeNinang({{ $index }})'
                                        class="absolute right-0 h-full px-3 transform bg-red-300 top-2/4 rounded-tr-md rounded-br-md -translate-y-2/4">
                                        <svg class="w-5 h-5 text-red-700 " xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <path
