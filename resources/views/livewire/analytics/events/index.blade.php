        ...
        <div class="mb-11">
            ...
            <nav class="flex mb-4" aria-label="Breadcrumb">
                ...
                <li class="inline-flex items-center">
                    <a href="{{route('analytics.events')}}" class="inline-flex items-center text-xs font-normal text-gray-600 hover:text-primary-red dark:text-gray-400 dark:hover:text-white">
                ...
                <li>
                    ...
                    <a href="{{route('analytics.events')}}" class="text-xs font-normal text-gray-600 ms-1 hover:text-primary-red md:ms-2 dark:text-gray-400 dark:hover:text-white">
                       Events
                    </a>
                    </div>
                </li>
