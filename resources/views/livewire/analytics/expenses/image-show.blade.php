    ...
    <div>
        <button id="myImage_{{ $index }}"
            ...
            <svg class="w-4 h-4 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 24 24">
                <path
                    d="M12 4.5C6.5 4.5 2 12 2 12s4.5 7.5 10 7.5 10-7.5 10-7.5-4.5-7.5-10-7.5zm0 11.25c-2.03 0-3.75-1.72-3.75-3.75S9.97 8.25 12 8.25 15.75 10 15.75 12 14.03 15.75 12 15.75zM12 10.5a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
            </svg>
            View Image
        </button>
    </div>
