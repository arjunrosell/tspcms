        ...
        <div @click.outside="closeModal" x-show="show" x-transition:enter="animate__animated animate__fadeIn"
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-3 dark:border-gray-600">
                ...
                <div class="p-4 space-y-4 md:p-5">
                    <div>
                        <label for="position"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Income Category</label>
                            <select wire:model='income_references_id' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-red focus:border-primary-red block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-red dark:focus:border-primary-red">
                                @forelse ($income_references as $income_reference)
                    ...
                    <div>
                        <label for="position"
                            ...
                            <select wire:model='received_by' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-red focus:border-primary-red block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-red dark:focus:border-primary-red">
                                @forelse ($users as $user)
                                    <option value="{{$user->id}}">{{$user->user_detail->fullName}}</option>
                                @empty
                                <option>No Available Data</option>
                                @endforelse
                            </select>
