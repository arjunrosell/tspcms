<x-modal.modal name="add">
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <div class="flex items-center justify-between p-4 border-b rounded-t md:p-3 dark:border-gray-600">
            ...
            <button @click="toggleShowModal" type="button"
                    ...
                    {{-- <div class="flex items-center justify-center mb-5 ">
                        <div class="relative inline-block ">
                            ...
                            <label for="profile_pic"
                                class="absolute flex items-center justify-center w-6 h-6 bg-gray-200 border border-gray-400 rounded-full cursor-pointer bottom-3 right-2">
                                <svg class="w-5 h-5 text-whitee" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        <div class="mb-5">
                            ...
                            <input type="email" wire:model='email'
                                ...
                                placeholder="example@gmalil.com" required />
                        </div>
                        <div class="mb-5">
                            <label for="password"
                ...
                <div class="col-span-2 p-2 border border-gray-200 rounded-md ">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-5">
                        <div>
                            <label for="contact_no"
                                ...
                                Number</label>
                            <input type="number" wire:model="contact_no"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-red focus:border-primary-red block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-red dark:focus:border-primary-red"
                                required />
                        </div>
                        <div>
                    ...
                    <div>
                        <label for="perm_address"
                            ...
                            Address</label>
                        <textarea wire:model='permanent_address' rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-red focus:border-primary-red dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-red dark:focus:border-primary-red"
                            placeholder="Enter your permanent..."></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="p-2 border border-gray-200 rounded-md ">
                    ...
                    <div class="flex items-center justify-center mb-5 ">
                        <div class="relative inline-block ">
                            ...
                            <label for="profile_pic"
                                class="absolute flex items-center justify-center w-6 h-6 bg-gray-200 border border-gray-400 rounded-full cursor-pointer bottom-3 right-2">
                                <svg class="w-5 h-5 text-whitee" aria-hidden="true"
