<x-modal.modal name="add">
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center justify-end p-4 border-t border-gray-200 rounded-b md:p-3 dark:border-gray-600">
            <x-forms.button @click="closeModal" class="flex items-center gap-1 text-xs font-normal tracking-wide border rounded-md shadow-lg focus:outline-none group text-black border-primary-red hover:text-white hover:bg-indigo-700 me-2 ">
                Close
            </x-forms.button>
